...
|----|---------|----------|---------------|--------|------|---------|
| PROJ-1 | Supabase-Infrastruktur-Setup — Projekt-Setup, Env-Variablen, DB-Schema-Grundgerüst, Auth (E-Mail+Passwort), RLS | P0 | None | In Review | [Spec](PROJ-1-supabase-infrastruktur-setup.md) | 2026-07-28 |
