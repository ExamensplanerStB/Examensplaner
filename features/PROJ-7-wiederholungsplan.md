...
- Als Lukas möchte ich einen Eintrag anklicken und direkt vorgefiltert im richtigen Hub landen, damit ich die eigentliche Bewertung/Nacharbeit ganz normal dort erledige, ohne dass die Bewertungslogik doppelt existiert.
...
### Verlinkung & Aktionen
- [ ] Angenommen der Nutzer klickt auf einen Karteikarten-Eintrag, dann wird er zum Karteikarten-Hub navigiert mit Fach und Typ bereits als Filter vorausgewählt
- [ ] Angenommen der Nutzer klickt auf einen Übungsaufgaben-Eintrag, dann wird er zum Übungsaufgaben-Hub navigiert mit dem Fach bereits als Filter vorausgewählt
- [ ] Angenommen der Nutzer klickt auf einen Probeklausur-Eintrag (außerhalb des „Erledigt"-Buttons), dann wird er zum Probeklausuren-Hub navigiert mit dem Fach der Klausur bereits als Filter vorausgewählt
...
| Klick auf einen Karteikarten-Eintrag setzt nur Fach-/Typ-Filter im Karteikarten-Hub, startet NICHT automatisch die Fokuseinheit | Die bestehende Fokuseinheit (PROJ-3) ist für einen Fach+Typ-Filtersatz aller fälligen Karten ausgelegt, nicht für eine einzelne angeklickte Karte — ein Auto-Start würde eine Erweiterung an PROJ-3 erfordern. Einfache Filter-Vorauswahl reicht für den Zweck und hält PROJ-7 unabhängig von PROJ-3-Änderungen | 2026-09-10 |
